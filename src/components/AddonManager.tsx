// Reusable addon management UI — install, list, remove.
// Used by AddonsPage (standalone /addons route) and AddonsSettings (Settings hub).
...
export default function AddonManager() {
  ...
  async function handleInstallFake() {
    ...
    if (!fn) {
      setInstallError("installFake is only available in development builds.");
      return;
    }
    setInstallError(null);
    try {
